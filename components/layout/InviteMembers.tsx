...
const InviteMembers = ({ workspaceId }: { workspaceId: string }) => {
    const [name, setName] = useState("")
    const [selectedUser, setSelectedUser] = useState<{ name: string; email: string; avatarUrl: string | null } | null>(null)
    ...
    const onClickInviteMember = async () => {
        ...
        try {
            await InivitationService.sendInivitation(workspaceId, {
        ...
        <form>
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Search and invite people to collaborate on your workspace.
                    </DialogDescription>
                </DialogHeader>
